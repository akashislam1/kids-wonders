...
const UpdateModal = ({ toy }) => {
  ...
  return (
    <>
      ...
      <label
        htmlFor="my-modal"
        className="font-bold text-white bg-[#4acdd5] text-center  rounded  hover:bg-white hover:text-[#4acdd5] border hover:border-[#4acdd5] duration-200 py-2 px-4  focus:outline-none focus:shadow-outline mr-3"
      >
        Update
      </label>
